...
# Combine all models and vectorizer into one dictionary
model_bundle = {
...
# Save the bundle to a single .pkl file
with open('spam_models_bundle.pkl', 'wb') as f:
    pickle.dump(model_bundle, f)

print("All models and vectorizer saved to 'spam_models_bundle.pkl'")
